...
public class DateTimeUtils {
    ...
    public static DateInterval getLastWeekInterVal(){
        ...
        LocalDate mondayLastWeek=saturdayLastWeek.minusDays(5);// Monday Last Week
        return  DateInterval.of(mondayLastWeek.atStartOfDay(),saturdayLastWeek.atTime(HOUR_23,MINUTE_59,SECOND_59));
    }
}
